This is a https://github.com/varabyte/kobweb[Kobweb] project bootstrapped with the `app/empty` template.
...
using the https://www.jetbrains.com/toolbox-app/[Toolbox App].
